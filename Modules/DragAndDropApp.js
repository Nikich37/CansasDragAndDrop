...
var DragAndDropApp = /** @class */ (function () {
    function DragAndDropApp() {
        ...
        this.shapes = [
            new Shapes_1.Shape([new Shapes_1.Point(100, 100), new Shapes_1.Point(200, 200), new Shapes_1.Point(100, 200)]),
            new Shapes_1.Shape([new Shapes_1.Point(100, 250), new Shapes_1.Point(300, 250), new Shapes_1.Point(300, 400), new Shapes_1.Point(100, 400)]),
            new Shapes_1.Shape([new Shapes_1.Point(100, 450), new Shapes_1.Point(300, 520), new Shapes_1.Point(300, 550), new Shapes_1.Point(200, 535), new Shapes_1.Point(100, 570)])
        ];
...
exports.DragAndDropApp = DragAndDropApp;
